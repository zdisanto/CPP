// CODECADEMY >> C++ >> Chapter 3 >> Lesson 1 >> Conditionals & Logic >> REVIEW
/*  
...
int main() {
  ...
  if (planet == 1) {
    ...
    std::cout << "You will weigh " << planetWeight << " pounds on Mercury!\n";  
  } else if (planet == 2) {
    planetWeight = earthWeight * .91;
    std::cout << "You will weigh " << planetWeight << " pounds on Venus!\n";  
  } else if (planet == 3) {
    planetWeight = earthWeight * .38;
    std::cout << "You will weigh " << planetWeight << " pounds on Mars!\n";  
  } else if (planet == 4) {
    planetWeight = earthWeight * 2.34;
    std::cout << "You will weigh " << planetWeight << " pounds on Jupiter!\n";  
  } else if (planet == 5) {
    planetWeight = earthWeight * 1.06;
    std::cout << "You will weigh " << planetWeight << " pounds on Saturn!\n";  
  } else if (planet == 6) {
    planetWeight = earthWeight * .92;
    std::cout << "You will weigh " << planetWeight << " pounds on Uranus!\n";  
  } else if (planet == 7) {
    planetWeight = earthWeight * 1.19;
    std::cout << "You will weigh " << planetWeight << " pounds on Neptune!\n";  
  } else {
